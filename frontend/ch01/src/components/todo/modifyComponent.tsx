...
function ModifyComponent({tno}: {tno: number}) {
    ...
    const handleChangeTodoCoomplete = (e: ChangeEvent<HTMLSelectElement>) => {
    ...
    const handleClickModify = () => {
        const todoModify:TodoModify = {tno: todo.tno, title: todo.title, writer:todo.writer, dueDate: todo.dueDate, complete:todo.complete}
        ...
        <div className="border-2 border-sky-200 mt-10 m-2 p-4">
            ...
            <div className="flex justify-center">
                <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                    ...
                    onChange={handleChangeTodoCoomplete}
