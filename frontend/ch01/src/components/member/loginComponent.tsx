...
function LoginComponent() {
    ...
    const {moveToPath, doLogin, loginStatus} = useCustomLogin()
                ...
                <div className="flex-col justify-center">
                    ...
                    <div className="flex justify-center">
                        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                            ...
                            name="email" type={"text"} onChange={(e) => setEmail(e.target.value)}></input>
                        </div>
                    </div>
                    <div className="flex justify-center">
                        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                            ...
                            <input className="w-full p-6 rounded-r border border-solid border-neutral-500 shadow-md"
                            name="pw" type={"password"} onChange={(e) => setPw(e.target.value)}></input>
                        </div>
                    </div>
                    <div className="flex justify-center">
