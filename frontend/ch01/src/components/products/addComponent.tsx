...
function AddComponent() {
    ...
    return (  
        <div className="border-2 border-sky-200 mt-10 m-2 p-4">
            ...
            title="상품 추가 결과" content={`새로운 ${state.result} 상품 추가됨`} callbackFn={closeModal}/>}

            <form action={action}>
                <div className="flex justify-center">
                    <div className="relative mb-4 flex w-full flex-warp items-stretch">
                        <div className="w-1/5 p-6 text-right font-bold">Product Name</div>
                        <input className="w-4/5 p-6 rounded-4 border border-solid border-neutral-300 shadow-md"
                        name="pname" required>
                        </input>
                    </div>
                </div>
                ...
                <div className="flex justify-center">
                    <div className="relative mb-4 flex w-full flex-warp items-stretch">
                        ...
                        <input className="w-4/5 p-6 rounded-4 border border-solid border-neutral-300 shadow-md"
                        name="files" type="file" multiple={true} required>
                        </input>
                    </div>
                </div>
